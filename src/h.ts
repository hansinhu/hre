import { Attributes, FC, HreNode, IFiber, PropsWithChildren, HreElement } from './type'
...
export function createText(vnode: string) {
  return { type: 'text', props: { nodeValue: vnode } } as HreElement
}

export const Fragment = (props: PropsWithChildren): HreNode => {
