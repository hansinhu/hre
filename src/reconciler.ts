...
const reconcileWork = (timeout: boolean): boolean | null | ITaskCallback => {
  ...
  console.log(5, `cb--WIP: diff start: <App/>`)
...
const reconcile = (WIP: IFiber): IFiber | undefined => {
  console.log(6, `diff loop: ${typeof WIP.type === 'function' ? 'APP' : WIP.type}`, WIP)
...
const reconcileChildren = (WIP: IFiber, children: HreNode): void => {
  console.log(8, 'kids op')
  delete WIP.child
